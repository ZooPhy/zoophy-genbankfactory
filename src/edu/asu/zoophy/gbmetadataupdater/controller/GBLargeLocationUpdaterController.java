 ...
 *
 */
public class GBLargeLocationUpdaterController implements ControllerInt {
	final private Logger log = Logger.getLogger(GBMetadataUpdater.class);
	private final static String SELECT_COUNT = "Select count(*) as total from \"Sequence_Details\" where \"Accession\" not in (Select \"Accession\" from \"Location_Geoname_2\")";
	private final static String SELECT_NULL_ACCESSIONS = "Select \"Accession\" from \"Sequence_Details\" where \"Accession\" not in (Select \"Accession\" from \"Location_Geoname_2\")";
	...
	private final static String INSERT_METADATA = "Insert into \"Location_Geoname_2\" Values (?,?,?,?,?,?,?)";
