...
public class GBLargeGeneMetadataController implements ControllerInt {
	...
	public void run() throws Exception{
		...
		try {
			...
			query1 = new DBQuery(ResourceProvider.getDBInterfacer(RP_PROVIDED_RESOURCES.ANNOTATION_DBI).getConnection(), DBQuery.QT_SELECT_MULTIPLE_ROWS, SELECT_GENEIDs, queryParams1);
