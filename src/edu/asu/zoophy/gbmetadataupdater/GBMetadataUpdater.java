...
import edu.asu.zoophy.gbmetadataupdater.controller.GBLocationTestController;
...
public class GBMetadataUpdater {
	...
	public void run() throws Exception{
		try  {
			//controller = new GBTestGeneMetadataController();
			//controller = new GBLargeMetadataTestController();
		//This is the current one:	controller = new GBLargeLocationUpdaterController2();
			//controller = new GBTimeNormalizerController();
			//controller = new GBLocationTestController();
			//controller = new GBLargeLatLngUpdaterController();
