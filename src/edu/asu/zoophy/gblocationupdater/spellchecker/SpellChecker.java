...
public class SpellChecker {
	...
	private void initializePhoneticsMap() {
		phoneticMap = new LinkedHashMap<String, String>();
		phoneticMap.put("q", "k");
		phoneticMap.put("k", "q");
		phoneticMap.put("k", "c");
		phoneticMap.put("c", "k");
		phoneticMap.put("iya", "ia");
		phoneticMap.put("f", "ph");
		phoneticMap.put("ph", "f");
		phoneticMap.put("y", "i");
		phoneticMap.put("ee", "i");
		phoneticMap.put("yo", "o");
		phoneticMap.put("yi", "i");
		phoneticMap.put("yu", "u");
		phoneticMap.put("ya", "a");
		phoneticMap.put("ye", "e");
		phoneticMap.put("ou", "u");
		phoneticMap.put("ou", "o");
		phoneticMap.put("uo", "u");
		phoneticMap.put("uo", "o");
		phoneticMap.put("ue", "e");
		phoneticMap.put("io", "o");
	}
