...
//	private Corpus corpus = null;
	...
	public Indexer(String indexPath) throws IndexerException {
	    ...
	    continents = new HashSet<Integer>(8, 1.0f); //TODO
	    continents.add(6255146); // Africa
	    continents.add(6255147); // Asia
	    continents.add(6255148); // Europe
	    continents.add(6255149); // North America
	    continents.add(6255150); // South America
	    continents.add(6255151); // Oceania
	    continents.add(6255152); // Antarctica
