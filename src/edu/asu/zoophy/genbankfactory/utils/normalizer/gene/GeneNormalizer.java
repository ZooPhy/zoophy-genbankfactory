...
public class GeneNormalizer {
	...
	private void prepareRuleData() {
		...
		wnMappings.put("capsid protein", "C");
		wnMappings.put("anchored capsid protein", "C");
		wnMappings.put("m", "M");
		wnMappings.put("membrane", "M");
		wnMappings.put("membrane protein m", "M");
		wnMappings.put("m", "M");
		wnMappings.put("pre m", "M");
		wnMappings.put("prem", "M");
		wnMappings.put("pre-membrane", "M");
		wnMappings.put("prm", "M");
		wnMappings.put("prM protein", "M");
		wnMappings.put("premembrane", "M");
		wnMappings.put("pre-membrane protein", "M");
		wnMappings.put("membrane glycoprotein precursor", "M");
		wnMappings.put("pre-membrane protein prm", "M");
		wnMappings.put("pre-M", "M");
		wnMappings.put("e", "E");
		wnMappings.put("env", "E");
		wnMappings.put("envelope", "E");
		wnMappings.put("envelope protein", "E");
		wnMappings.put("envelope glycoprotein", "E");
		wnMappings.put("envelope glycoprotein e", "E");
		wnMappings.put("polyprotein", "NS");
		wnMappings.put("ns", "NS");
		wnMappings.put("nonstructural", "NS");
		wnMappings.put("non-structural", "NS");
		wnMappings.put("nonstructural protein 1", "NS1");
		wnMappings.put("nonstructural protein 2a", "NS2a");
		wnMappings.put("nonstructural protein 2b", "NS2b");
		wnMappings.put("non-structural protein 1", "NS1");
		wnMappings.put("non-structural protein 2a", "NS2a");
		wnMappings.put("non-structural protein 2b", "NS2b");
		wnMappings.put("ns3", "NS3");
		wnMappings.put("nonstructural protein 3", "NS3");
		wnMappings.put("nonstructural protein 4a", "NS4a");
		wnMappings.put("nonstructural protein 4b", "NS4b");
		wnMappings.put("non-structural protein 3", "NS3");
		wnMappings.put("non-structural protein 4a", "NS4a");
		// 2K peptide is between NS4A and NS4B - https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5388927/
		// put it in NS4A for now
		wnMappings.put("2K peptide", "NS4a"); 
		wnMappings.put("non-structural protein 4b", "NS4b");
		wnMappings.put("ns5", "NS5");
		wnMappings.put("nonstructural protein 5", "NS5");
