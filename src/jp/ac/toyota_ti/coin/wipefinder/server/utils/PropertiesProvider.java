...
public class PropertiesProvider {
	...
	/**
	 * Read a file which contains the properties. Other values maybe include in
	 * the constructor.
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * Load the properties file in memory. The File is closed when loading is
	 * done.
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * Merge this Properties Provider with the one given in Parameter, if a
	 * property already exits the old value is kept
	 */
