...
public class DBManager {
	...
	/**
	 * Create a Connection to the Database, where the details are provided by
	 * the properties provider open in the Dataprovider
	 * 
	 * @throws Exception
	 */
	public DBManager() throws Exception {
		log.info("DB Interfacer initialisation...");
		Name = (String) ResourceProvider.getPropertiesProvider(RP_PROVIDED_RESOURCES.PROPERTIES_PROVIDER)
				.getValue("DB.Big.Name");
		Host = (String) ResourceProvider.getPropertiesProvider(RP_PROVIDED_RESOURCES.PROPERTIES_PROVIDER)
				.getValue("DB.Host");
		User = (String) ResourceProvider.getPropertiesProvider(RP_PROVIDED_RESOURCES.PROPERTIES_PROVIDER)
				.getValue("DB.User");
		PW = (String) ResourceProvider.getPropertiesProvider(RP_PROVIDED_RESOURCES.PROPERTIES_PROVIDER)
				.getValue("DB.PW");
		try {
